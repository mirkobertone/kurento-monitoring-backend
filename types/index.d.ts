...
declare module "kurento-client" {
    namespace k {
      interface Constructor {
          (ws_uri: string, options?: Options, callback?: any): Promise<ClientInstance>;
      ...
      interface ServerManager {
          ...
          getInfo: (callback?: Callback<ServerInfo>) => Promise<ServerInfo>;
          on(
              event: 'ObjectCreated',
